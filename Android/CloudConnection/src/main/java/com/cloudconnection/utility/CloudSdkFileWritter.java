 ...
 * @since 16 Sep 2015.
 */
public class CloudSdkFileWritter {

    public static final String TAG = "Cloud SDK : WriteDataToFile";

    private final static String mFileName = "api_calls.txt";

    private final static String mFolderName = "SDK_State";
